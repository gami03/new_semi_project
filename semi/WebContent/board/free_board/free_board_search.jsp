				...
				success : function(response) {
					...
					if(response.list.length > 0) {
						...
						$.each(response.list, function(index, board) {
							...
							html += "</td>"
								+ "<td style='text-align: left;'><a href='<%=request.getContextPath() %>/board_content.do?no=" + board.board_no + "&page=" + response.page + "&id=${user_id }&nickname=" + board.user_nickname + "&keyword=${keyword }&field=${field }&orderBy=hit&board_name="+ board.board_name +"'>"+"["+board.board_category+"]"+"&nbsp;"+ board.board_title + "</a></td>"
			...
			success : function(response) {
				...
				if(response.list.length > 0) {
					...
					$.each(response.list, function(index, board) {
						...
						html += "</td>"
							+ "<td style='text-align: left;'><a href='<%=request.getContextPath() %>/board_content.do?no=" + board.board_no + "&page=" + response.page + "&id=${user_id }&nickname=" + board.user_nickname + "&keyword=${keyword }&field=${field }&orderBy=time&board_name="+ board.board_name +"'>" +"["+board.board_category+"]"+"&nbsp;"+ board.board_title + "</a></td>"
									+ "<td>"+board.user_nickname+"</td>"
									+ "<td>"+board.board_date.substring(0,10)+"</td>"
									+ "<td>"+board.board_hit+"</td>"
									+ "</tr>";
		    ...
		    success: function(response) {
		      ...
		      if (response.list.length > 0) {
		        ...
		        $.each(response.list, function(index, board) {
		          ...
		          html += "</td>" +
		            "<td style='text-align: left;'><a href='<%=request.getContextPath() %>/board_content.do?no=" + board.board_no + "&page=" + response.page + "&id=${user_id }&nickname=" + board.user_nickname +"&keyword=${keyword }&field=${field }&orderBy=look&board_name="+ board.board_name + "'>" +"["+board.board_category+"]"+"&nbsp;"+ board.board_title + "</a></td>" +
		            "<td>" + board.user_nickname + "</td>" +
		            "<td>" + board.board_date.substring(0, 10) + "</td>" +
		            "<td>" + board.board_hit + "</td>" +
		            "</tr>";
