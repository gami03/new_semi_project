                  ...
                  <div class="row">
                     ...
                     <div class="col-2">
                        <div id="product-imgs">
                           ...
                           <div style="height: 123.89px" class="product-preview">
                              <img style="height: 123.89px" src="<%=request.getContextPath() %>/./board/sale_board/sale_board_file_upload${dto.getSale_file3() }" alt="">
                           </div>
                           
                           <div style="height: 123.89px" class="product-preview">
                              <img style="height: 123.89px" src="<%=request.getContextPath() %>/./board/sale_board/sale_board_file_upload${dto.getSale_file4() }" alt="">
                           </div>
                        </div>
                     </div>
                     <!-- Product main img -->
